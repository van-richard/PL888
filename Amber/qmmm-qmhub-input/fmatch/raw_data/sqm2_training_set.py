...
&qmmm
 ...
 qmcharge = ${charge},
 spin     = ${mult},
 parameter_file='/scratch/van/cas9/hnh/b3lyp-pm3-sinr/fmatch/param.dat',
 maxcyc   = 0,
 verbosity= 5,
 /
"""
...
if __name__ == "__main__":
    ...
    np.save("energy_sqm2", energy)
    np.save("qm_grad_sqm2", np.array(qm_grad, dtype='float32'))
    np.save("mm_esp_sqm2", np.array(mm_esp, dtype='float32'))
    np.save("mm_esp_grad_sqm2", np.array(mm_esp_grad, dtype='float32'))
