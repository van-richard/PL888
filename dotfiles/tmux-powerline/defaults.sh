...
export TMUX_POWERLINE_STATUS_VISIBILITY_DEFAULT="2"
...
export TMUX_POWERLINE_STATUS_LEFT_LENGTH_DEFAULT=100
export TMUX_POWERLINE_STATUS_RIGHT_LENGTH_DEFAULT=100
...
export TMUX_POWERLINE_STATUS_FORMAT_LEFT_DEFAULT="#{p3:#[align=left range=left #{E:status-left-style}]#[push-default]#{T;=/#{status-left-length}:status-left}#[pop-default]#[norange default]}"
export TMUX_POWERLINE_STATUS_FORMAT_RIGHT_DEFAULT="#{p3:#[nolist align=right range=right #{E:status-right-style}]#[push-default]#{T;=/#{status-right-length}:status-right}#[pop-default]#[norange default]}"
