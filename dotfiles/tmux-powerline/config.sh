...
# General {
	...
	#export TMUX_POWERLINE_DIR_USER_THEMES="$HOME/.tmux/plugins/tmux-powerline/themes"
	#export TMUX_POWERLINE_DIR_USER_THEMES="${XDG_CONFIG_HOME:-$HOME/.tmux/plugins}/tmux-powerline/themes"
	# Overlay directory to look for segments. There you can put your own segments outside the repo. Fallback will still be the "segments" directory in the repo.
	#export TMUX_POWERLINE_DIR_USER_SEGMENTS="$HOME/.tmux/plugins/tmux-powerline/segments"
	#export TMUX_POWERLINE_DIR_USER_SEGMENTS="${XDG_CONFIG_HOME:-$HOME/.tmux/plugins}/tmux-powerline/segments"
	...
	export TMUX_POWERLINE_STATUS_INTERVAL="600"
